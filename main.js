(function () {
    ...
    link1.h1 = document.createTextNode('Beetroot Academy - Odessa');
    ...
    link1.innerHTML = 'Beetroot Academy - Odessa';

    linkSecond.setAttribute('href', "https://docs.google.com/…/1FAIpQLSe6ntpTYt3C2ERH6z…/viewform");
        linkSecond.innerHTML = 'https://docs.google.com/…/1FAIpQLSe6ntpTYt3C2ERH6z…/viewform';
    ...
    pLast.innerHTML = 'Тебе бы хотелось выиграть степендию которая полностью покроет,стоимость обучения на одном из наших четырех курсов';

    appElement.prepend(img);
    appElement.append(link1, p, imgSecond,  h3,linkSecond, pLast);
